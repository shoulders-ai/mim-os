...
const sections = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: shortcutLabel(['Mod', 'E']), label: 'Cycle view mode (Markdown)' },
      { keys: shortcutLabel(['Shift', 'Mod', 'M']), label: 'Comment on selection' },
      { keys: shortcutLabel(['Mod', 'Enter']), label: 'Send line or selection to terminal (code files)' },
      { keys: shortcutLabel(['Shift', 'Mod', 'Enter']), label: 'Source file or send chunk to terminal' },
  ...
  },
  {
    ...
    shortcuts: [
      { keys: shortcutLabel(['Mod', 'Enter']), label: 'Accept change (diff review)' },
      { keys: shortcutLabel(['Alt', '↑']), label: 'Previous chunk (diff review)' },
      { keys: shortcutLabel(['Alt', '↓']), label: 'Next chunk (diff review)' },
      { keys: shortcutLabel(['Tab']), label: 'Accept ghost suggestion' },
      { keys: shortcutLabel(['Alt', '→']), label: 'Accept next word (ghost suggestion)' },
      { keys: shortcutLabel(['Esc']), label: 'Dismiss review or suggestion' },
    ],
  },
]
</script>
