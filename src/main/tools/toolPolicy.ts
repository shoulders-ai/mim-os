...
export const CORE_TOOL_POLICY_ROWS: ToolPolicyRow[] = [
  ...
  },
  {
    ...
    description: 'Execute detected interpreters (Rscript, Quarto) on workspace files. Used by the editor Render button and headless CLI.',
    defaultEnabled: true,
    toolIds: ['code.run'],
    risk: 'sensitive',
  },
  {
    ...
    domain: 'code',
    label: 'Bash',
    description: 'Full shell access with captured output. Every call still requires approval; disable to remove agent command execution entirely.',
    defaultEnabled: true,
    toolIds: ['shell.run'],
    aiToolKeys: ['bash'],
    risk: 'sensitive',
