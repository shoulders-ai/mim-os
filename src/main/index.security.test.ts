...
vi.mock('@main/tools/registryTools.js', () => ({ registerRegistryTools: vi.fn() }))
vi.mock('@main/packages/registrySources.js', () => ({ lookupRegistryEntry: vi.fn() }))
vi.mock('@main/tools/install.js', () => ({ registerInstallTools: vi.fn() }))
vi.mock('@main/packages/cacheLayout.js', () => ({ DEFAULT_CACHE_ROOT: '/tmp/mock-cache' }))
vi.mock('@main/tools/logbook.js', () => ({ registerLogbookTools: vi.fn() }))
vi.mock('@main/tools/slack.js', () => ({ registerSlackTools: vi.fn() }))
vi.mock('@main/tools/google.js', () => ({ registerGoogleTools: vi.fn() }))
